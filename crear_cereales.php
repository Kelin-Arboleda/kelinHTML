...
<?php 
        ...
        )
    {
        ...
        $insertar = mysqli_query($conexion, "INSERT INTO cereales(producto,unidad,valor) 
            VALUES('$producto','$unidad','$valor')");
 ...
 ?>
    ...
    <div class="row"><!--Paso 5 meter formulario dentro de una fila></!-->
        ...
        <form action="crear_cereales.php" class="col-md-8" method="POST"><!--Paso 6 tamaño de los campos></!-->
